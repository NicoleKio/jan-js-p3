...
for (let i = 0; i < usersPassword.length; i++) {
    ...
    document.write(`<div>${usersPasswordElement.name}'s nickname is ${usersPasswordElement.username}</div>`)
}
...
for (const product of products) {
    document.write(`<div class="product-card">
                        ...
                        <img style="width: 200px;" src="${product.image}" alt="${product.title}" class="product-image">
                    </div>`)
}
...
for (let j = 0; j < users.length; j++) {
    const user = users[j];
    if (user.status === true){
        document.write(`<p>${user.name}'s status is ${user.status}</p>`)
    }
}
...
for (let j = 0; j < users.length; j++) {
    ...
    if (user.status === false){
        document.write(`<h3>${user.name}'s status is ${user.status}</h3>`)
    }
}
...
for (let j = 0; j < users.length; j++) {
    const user = users[j];
    if (user.age > 30){
        document.write(`<p>${user.name} is ${user.age} y.o.</p>`)
    }
}